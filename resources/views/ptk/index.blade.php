    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="card border-0 shadow-sm mt-5 mb-3"
                ...
                style="cursor:pointer; background:#1a5bb8; color:white; border-radius:14px;">

                <div class="card-body d-flex justify-content-between align-items-center py-4">
                    <h5 class="mb-0 text-white">Profil Pengguna</h5>
                    <i class="ri-arrow-down-s-line fs-3 text-white" id="iconToggle"></i>
                </div>
            </div>

            <!-- ISI PROFIL -->
            <div id="profilCollapse" class="collapse show">
                <div class="card p-4 border-0 shadow-sm mt-0" style="border-radius:14px;">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">Syntyce Solution</h4>
                            <p class="text-muted mb-2">Michael Morris</p>
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <td class="fw-semibold" width="180">Industry Type</td>
