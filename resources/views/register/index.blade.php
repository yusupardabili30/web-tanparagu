                        ...
                        <div class="big-box mb-3">
                            ...
                            <form id="profilForm" action="{{ route('register.store', $encode_kegiatan_id) }}" method="POST">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-2">
                                            <input name="nip" required class="form-control form-control-lg" placeholder=" " value="{{ old('nip') }}">
                                        ...
                                        <div class="form-floating mb-2">
                                            <select name="pangkat_jabatan_id" class="form-select" required style="font-size:16px; color:#555555 !important;">
                                                ...
                                                <option value="{{ $jabatan->pangkat_jabatan_id }}" {{ old('pangkat_jabatan_id') == $jabatan->pangkat_jabatan_id ? 'selected' : '' }}>
                                                    {{ $jabatan->jenjang_jabatan }} - {{ $jabatan->pangkat }}
                                                </option>
                                                @endforeach
                                            </select>
                                            <label>Jabatan</label>
                                ...
                                <div class="big-box mt-3">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                <input name="website" class="form-control form-control-lg" placeholder=" " value="{{ old('website') }}">
                                                <label>Website</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-floating mb-2">
                                        <input name="npwp" required class="form-control form-control-lg" placeholder=" " value="{{ old('npwp') }}">
                                        <label>NPWP</label>
                                        @error('npwp')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-4">
                                            <div class="form-floating mb-2">
                                                <select name="nama_bank" class="form-select" style="color: #555555" required>
                                                    <option value="">Pilih Bank</option>
                                                    <option value="BRI" {{ old('nama_bank') == 'BRI' ? 'selected' : '' }}>Bank BRI</option>
                                                    <option value="BCA" {{ old('nama_bank') == 'BCA' ? 'selected' : '' }}>Bank BCA</option>
                                                    <option value="BNI" {{ old('nama_bank') == 'BNI' ? 'selected' : '' }}>Bank BNI</option>
