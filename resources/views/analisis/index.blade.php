...
@section('mycontent')
    ...
    <style>
        ...
        //* =====================================================
        JENJANG CHARTS SCROLL CONTAINER=====================================================*/ .jenjang-charts-scroll-container {
            position: relative;
            width: 100%;
        }
                                            ...
                                            <div class="tab-pane fade {{ $jenjangIndex == 0 ? 'show active' : '' }}"
                                                ...
                                                @else
                                                    <div class="alert alert-success text-center py-4">
                                                        ...
                                                        <h5 class="mt-2 mb-0">Semua PTK sudah mencapai target!</h5>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="table-card">
                    <div class="chart-title">
                        <i class="ri-list-check-2"></i> Rekomendasi Kebutuhan Belajar per Jenjang Jabatan
                        <small class="text-muted ms-2">(Hanya menampilkan sub indikator yang belum mencapai target)</small>
                    </div>
