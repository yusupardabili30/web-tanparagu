...
@section('mycontent')
    ...
    <style>
        ...
        .table-responsive .table {
            min-width: 980px;
            /* bisa kamu naikin kalau kolom banyak */
            width: max-content;
        }
        ...
        #jenjangChartsContainer .chart-card .chart-wrapper {
            position: relative;
            height: 260px;
            /* sesuaikan sama kebutuhan */
            padding-top: 18px;
            /* INI kunci: ruang buat legend */
        }
...
/* default: kolom lain tetap nowrap */
...
#jenjangTabContent .table-responsive .table td:nth-child(2){ width: 32%; }
#jenjangTabContent .table-responsive .table td:nth-child(6){ width: 34%; }


/* =========================================================
   CUMA KECILIN BUTTON "Lihat Detail PTK"
   - icon ga ilang
   - teks fit (bisa 2 baris)
   - kolom detail ga makan tempat
   ========================================================= */
#jenjangTabContent table th:nth-child(8),
#jenjangTabContent table td:nth-child(8){
...
#jenjangTabContent table td:nth-child(8) .btn{
  ...
  white-space: normal !important; /* boleh 2 baris */
  flex-wrap: wrap !important;
  text-align: left !important;
}

#jenjangTabContent table td:nth-child(8) .btn i{
  font-size: 13px !important;
  margin: 0 !important;
  flex: 0 0 auto !important;
}
/* CENTER + HAPUS ICON tombol Detail PTK (kolom 8) */
#jenjangTabContent table td:nth-child(8) .btn{
  display: inline-flex !important;
  flex-direction: column !important;
  align-items: center !important;
  ...
  white-space: normal !important; /* biar 2 baris */
  line-height: 1.05 !important;
}
...
/* ================================
   FORCE LEBAR KOLOM (TAB GAP)
   Biar Sub Indikator + Rekomendasi LEBAR
   ================================ */

/* pastikan tabel ga punya min-width aneh */
#jenjangTabContent .table-responsive{ overflow-x: auto !important; }

#jenjangTabContent .table-responsive .table{
  min-width: 0 !important;
  width: 100% !important;
  table-layout: fixed !important; /* wajib biar width per kolom nurut */
}

/* reset semua width lama biar ga “ketarik” */
#jenjangTabContent .table-responsive .table th,
#jenjangTabContent .table-responsive .table td{
  width: auto !important;
}
...
/* ==== KECILIN kolom angka ==== */
#jenjangTabContent .table-responsive .table th:nth-child(1),
#jenjangTabContent .table-responsive .table td:nth-child(1){ width: 42px !important; }   /* # */

#jenjangTabContent .table-responsive .table th:nth-child(3),
#jenjangTabContent .table-responsive .table td:nth-child(3){ width: 60px !important; }   /* No Urut */

#jenjangTabContent .table-responsive .table th:nth-child(4),
#jenjangTabContent .table-responsive .table td:nth-child(4){ width: 95px !important; }   /* Level Dicapai */

#jenjangTabContent .table-responsive .table th:nth-child(5),
#jenjangTabContent .table-responsive .table td:nth-child(5){ width: 85px !important; }   /* Level Gap */

#jenjangTabContent .table-responsive .table th:nth-child(7),
#jenjangTabContent .table-responsive .table td:nth-child(7){ width: 80px !important; }   /* Jumlah PTK */

#jenjangTabContent .table-responsive .table th:nth-child(8),
#jenjangTabContent .table-responsive .table td:nth-child(8){ width: 110px !important; }  /* Detail PTK */

#jenjangTabContent .table-responsive .table th:nth-child(9),
#jenjangTabContent .table-responsive .table td:nth-child(9){ width: 140px !important; }  /* % dari total */

/* ==== LEBARIN 2 kolom utama ==== */
#jenjangTabContent .table-responsive .table th:nth-child(2),
#jenjangTabContent .table-responsive .table td:nth-child(2){
  width: 34% !important;                 /* SUB INDIKATOR LEBAR */
  white-space: normal !important;
  overflow-wrap: anywhere;
  word-break: break-word;
}
...
#jenjangTabContent .table-responsive .table th:nth-child(6),
#jenjangTabContent .table-responsive .table td:nth-child(6){
  width: 42% !important;                 /* REKOMENDASI PALING LEBAR */
  white-space: normal !important;
  overflow-wrap: anywhere;
  word-break: break-word;
  line-height: 1.35;
}
/* kecilin badge level di tabel rekomendasi (Level Dicapai & Level Gap) */
#jenjangTabContent .badge-level{
...
/* ================================
   PERSEMPIT KOLOM "% dari Total" (kolom 9)
   ================================ */
#jenjangTabContent table th:nth-child(9),
#jenjangTabContent table td:nth-child(9){
...
/* kecilin text persen + progress biar muat */
#jenjangTabContent table td:nth-child(9) .fw-bold{
  font-size: 12px !important;
  white-space: nowrap !important;
}

#jenjangTabContent table td:nth-child(9) .progress{
  min-width: 46px !important;
  height: 6px !important;
}

/* HP: lebih sempit lagi */
@media (max-width: 576px){
  #jenjangTabContent table th:nth-child(9),
  #jenjangTabContent table td:nth-child(9){
...
/* kolom % dari Total (kolom 9) -> progress bar di bawah angka */
#jenjangTabContent table td:nth-child(9) .d-flex{
  flex-direction: column !important;
  align-items: center !important;
  gap: 6px !important;
}
...
#jenjangTabContent table td:nth-child(9) .progress{
  width: 100% !important;
  max-width: 90px !important;   /* biar ga kepanjangan */
}
/* ================================
   RAPIIN JUDUL TABLE (thead)
   ================================ */
#jenjangTabContent .table thead th{
...
/* kolom sempit: #, No Urut, Level Dicapai, Level Gap, Jumlah PTK, % dari Total */
#jenjangTabContent table th:nth-child(1),
#jenjangTabContent table td:nth-child(1){
...
#jenjangTabContent table th:nth-child(3),
#jenjangTabContent table td:nth-child(3){
...
#jenjangTabContent table th:nth-child(4),
#jenjangTabContent table td:nth-child(4){
  width: 120px !important;
  min-width: 120px !important;
  max-width: 120px !important;
  text-align: center !important;
...
#jenjangTabContent table th:nth-child(5),
#jenjangTabContent table td:nth-child(5){
  width: 110px !important;
  min-width: 110px !important;
  max-width: 110px !important;
  text-align: center !important;
...
#jenjangTabContent table th:nth-child(7),
#jenjangTabContent table td:nth-child(7){
  width: 95px !important;
  min-width: 95px !important;
  max-width: 95px !important;
  text-align: center !important;
...
/* kolom panjang biar lega */
#jenjangTabContent table th:nth-child(2),
#jenjangTabContent table td:nth-child(2){
  width: 28% !important;
}

#jenjangTabContent table th:nth-child(6),
#jenjangTabContent table td:nth-child(6){
  width: 34% !important;
}
#jenjangTabContent .alert-info{
  background: #eef6ff;
        ...
        <div class="analisis-wrap">
            ...
            <div id="analisisContent">
                @if (isset($analisisData) && !isset($analisisData['error']))
                    ...
                    <div class="row">
                        <!-- Chart 2: Distribusi Level Terendah per PTK (BARU) -->
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <!-- Chart 2: Distribusi Level Terendah per PTK kota/kab (BARU) -->
                        <div class="col-md-6">
                            <div class="chart-container">
                                <div class="chart-title">
                    ...
                    <!-- Chart Row Baru: Distribusi Level per Kota -->
                                                ...
                                                <td>
                                                    <div class="progress" style="height: 8px;">
                                                        <div class="progress-bar
                                                            ...
                                                            role="progressbar" style="width: {{ $kota->persentase }}%;">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
@section('sipproja-js')
    ...
    <script>
        ...
        // Fungsi helper untuk mengambil parameter dari URL
        ...
        <div class="col-12">
            <div class="chart-container chart-container-large">
                <div class="chart-title">
                    ...
                    <span class="badge bg-info ms-2">Jumlah PTK per Level</span>
                    <small class="text-muted ms-2">
                        ${data.distribusi_level_per_kota.total_kota} kota ditampilkan
                    </small>
                </div>
                <canvas id="levelPerKotaChart" height="400"></canvas>
            </div>
...
// Di dalam updateAnalisisContent(data)
if (data.rekomendasi_gap_per_jenjang?.length > 0) {
  ...
  // total sub indikator (ambil dari chart labels kalau ada)
  ...
  data.rekomendasi_gap_per_jenjang.forEach((jenjang, jenjangIndex) => {
    ...
    gapHtml += `
      <div class="tab-pane fade ${jenjangIndex === 0 ? 'show active' : ''}"
        ...
        <div class="alert alert-danger py-3 px-4 mb-3"
            style="border-radius:14px; font-size:14px; font-weight:700; line-height:1.35;">
        Ada <b>${gapCount}</b> dari <b>${totalSub}</b> sub indikator yang belum mencapai level kompetensi
        </div>

    `;

    // ✅ lanjutkan table kamu seperti biasa (JANGAN masukin const di dalam backtick)
    gapHtml += `
      <div class="table-responsive">
        <table class="table table-bordered modus-table">
          <thead>
    ...
    jenjang.rekomendasi.forEach((rek) => {
      if (!rek.detail_gap || rek.detail_gap.length === 0) return;

      rek.detail_gap.forEach((gap, gapIndex) => {
        const percentage = jenjang.total_ptk > 0
          ? Math.round((gap.jumlah_ptk / jenjang.total_ptk) * 100 * 10) / 10
          : 0;

        const progressClass = percentage >= 30 ? 'bg-danger' : (percentage >= 15 ? 'bg-warning' : 'bg-info');
    ...
    <div class="col-md-3">
        ...
        function renderCharts(data) {
            ...
            [levelDistributionChart, jenjangDistributionChart, jenjangPendidikanChart, jenisKelaminChart,
                allSubIndikatorsChart, pelatihanChart, levelTerendahChart, levelTerendahkabkotaChart, levelPerKotaChart
            ].forEach(chart => {
                if (chart) {
                    try {
                        chart.destroy();
                            ...
                            tooltip: {
                                callbacks: {
                                    ...
                                    afterLabel: function(context) {
                                        const level = context.dataIndex + 1;
                                        const levelNames = ['Dasar', 'Penerapan', 'Analisis', 'Evaluasi',
                                            'Pembimbingan'
                                        ];
            ...
            if (levelTerendahkabkotaCtx && data.level_kota_per_ptk) {
                levelTerendahClevelTerendahkabkotaCharthart = new Chart(levelTerendahkabkotaCtx, {
                    type: 'bar',
                    data: {
            ...
            if (levelPerKotaCtx && data.distribusi_level_per_kota) {
                levelPerKotaChart = new Chart(levelPerKotaCtx, {
                    ...
                    options: {
                        ...
                        scales: {
                            x: {
                                stacked: true, // Ini yang membuat bar menjadi layered
                                title: {
                                    display: true,
                                    text: 'Kota'
                                }
                ...
                if (chartData.labels?.length > 0 && chartData.datasets?.length > 0) {
                    allSubIndikatorsChart = new Chart(allSubCtx, {
                        ...
                        data: {
                            ...
                            datasets: chartData.datasets // tetap pakai dataset asli
                        },
                        options: {
                            responsive: true,
                            maintainAspectRatio: false,
                    ...
                    // HANYA UBAH WARNA LEVEL 1 SETELAH CHART DIBUAT
                    if (allSubIndikatorsChart && allSubIndikatorsChart.data && allSubIndikatorsChart.data.datasets) {
                        allSubIndikatorsChart.data.datasets.forEach((dataset, index) => {
                            if (dataset.label && dataset.label.includes('Level 1')) {
                                dataset.backgroundColor = 'rgba(220, 53, 69, 0.8)';
                                dataset.borderColor = 'rgba(220, 53, 69, 1)';
                            }
                        });
                        allSubIndikatorsChart.update(); // Update chart dengan warna baru
                    }
                }
            }
        ...
        function renderJenjangCharts(data) {
            ...
            data.sub_indikator_per_jenjang.forEach((jenjangData, index) => {
                ...
                // Buat chart dengan data asli
                window[canvasId] = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: jenjangData.labels || [],
                        datasets: jenjangData.datasets // tetap pakai dataset asli
                    },
                    options: {
                        responsive: true,
                        maintainAspectRatio: false,
                ...
                // HANYA UBAH WARNA LEVEL 1 SETELAH CHART DIBUAT
                if (window[canvasId] && window[canvasId].data && window[canvasId].data.datasets) {
                    ...
                    window[canvasId].update(); // Update chart dengan warna baru
                }
