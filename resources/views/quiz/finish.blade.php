            ...
            <div class="card border-0 shadow-sm" style="border-radius:14px;">
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mb-2" style="font-size: 18px;">
                            <strong>Kegiatan ID:</strong> {{ $encoded_kegiatan_id }}
                        </p>
                        <p class="mb-2" style="font-size: 18px;">
                            <strong>Jumlah Soal Terjawab:</strong> {{ $jumlahJawaban }}
                        </p>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        @if(Route::has('ptk.show'))
                        <a href="{{ route('ptk.show', [
            'encode_kegiatan_id' => $encoded_kegiatan_id, 
            'nip' => $nip
        ]) }}" class="btn btn-outline-primary btn-lg">
                            <i class="ri-list-check-2 me-2"></i> Kembali ke PTK
                        </a>
                        @elseif(Route::has('kegiatan.index'))
                        <a href="{{ route('kegiatan.index') }}" class="btn btn-outline-primary btn-lg">
                            <i class="ri-list-check-2 me-2"></i> Lihat Kegiatan
                        </a>
                        @else
